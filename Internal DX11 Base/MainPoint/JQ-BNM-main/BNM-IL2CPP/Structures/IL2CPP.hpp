    ...
    */
    ...
    T Method::Invoke(Args... args)
    {
        if (this->isStatic())
        {
            ...
            {
                LOG_ERROR(std::string("Error: Couldn't invoke static method \"") + this->Name() + "\" from IL2CPP::Object.");
                return T{};
            }
        ...
        else
        {
            if (this->object_instance == nullptr)
            {
                LOG_ERROR(std::string("Error: Couldn't invoke non-static method \"") + this->Name() + "\" from IL2CPP::Class instance, use IL2CPP::Object instance instead.");
                return T{};
            }
